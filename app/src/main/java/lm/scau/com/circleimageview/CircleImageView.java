package lm.scau.com.circleimageview;
...
/**
 * Function:
 * auth：liming on 2017/11/28 10:36
 */
...
//            drawBackground(canvas, radius, mBackgroundColor);
//        }
    ...
    public Bitmap getCroppedRoundBitmap(Bitmap bmp, int radius) {
        ...
        if (bmpHeight > bmpWidth) {// 高大于宽
            ...
            squareBitmap = bmp;//Bitmap.createBitmap(bmp, 10, 10, bmpWidth-10, bmpWidth-10);
        }
     ...
     * 画背景
     */
    private void drawBackground(Canvas canvas, int radius, int color) {
        Paint paint = new Paint();
        /* 去锯齿 */
        paint.setAntiAlias(true);
        paint.setFilterBitmap(true);
